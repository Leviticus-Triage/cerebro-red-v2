...
from core.models import ExperimentConfig, ModelProvider, AttackStrategyType, AttackIteration
...
def experiment_config():
    ...
    return ExperimentConfig(
        ...
        description="Test",
        target_model_provider=ModelProvider.OLLAMA,
        target_model_name="qwen2.5:3b",
        attacker_model_provider=ModelProvider.OLLAMA,
        attacker_model_name="qwen3:8b",
        judge_model_provider=ModelProvider.OLLAMA,
...
async def test_failure_analysis_websocket_event():
    ...
    from core.orchestrator import RedTeamOrchestrator
    from core.models import ExperimentConfig, ModelProvider, AttackStrategyType
    from uuid import uuid4
