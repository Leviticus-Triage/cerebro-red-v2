...
class RepositoryConfigManager:
    ...
    def add_repository(self, repo_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.audit_logger.log_event(
            event_type="repository_added", metadata={"repo_name": repo_name, "config": repo_config}
        )
    ...
    def delete_repository(self, repo_name: str) -> Dict[str, Any]:
        ...
        # Log action
        self.audit_logger.log_event(
            event_type="repository_deleted", metadata={"repo_name": repo_name}
        )
    ...
    def get_update_history(
        ...
        if repo_name:
            history_entries = [
                entry for entry in history_entries if entry.get("repository") == repo_name
            ]
