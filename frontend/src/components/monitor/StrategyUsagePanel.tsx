  ...
  return (
    <div className="bg-slate-800 rounded-lg p-4 space-y-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-slate-400">{usageRate.toFixed(1)}% Usage Rate</div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div className="bg-slate-700 rounded p-3">
          ...
          <div className="text-2xl font-bold text-green-400">
            {Object.keys(usedStrategies).length}
          </div>
        </div>
        <div className="bg-slate-700 rounded p-3">
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-wrap gap-2">
            {skipped.map((strategy) => (
              <span key={strategy} className="px-2 py-1 bg-red-900/30 text-red-300 rounded text-xs">
                {strategy}
              </span>
            ))}
          </div>
