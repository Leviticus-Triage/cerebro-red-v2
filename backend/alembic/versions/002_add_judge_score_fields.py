...
def upgrade() -> None:
    ...
    op.add_column(
        "judge_scores", sa.Column("bias_score", sa.Float(), nullable=False, server_default="0.0")
    )
    op.add_column(
        "judge_scores",
        sa.Column("logical_consistency_score", sa.Float(), nullable=False, server_default="0.0"),
    )
    op.add_column(
        "judge_scores",
        sa.Column("sycophancy_score", sa.Float(), nullable=False, server_default="0.0"),
    )
