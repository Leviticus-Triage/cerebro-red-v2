        ...
        "vulnerabilities": [
            {
                ...
                "attack_strategy": v.attack_strategy if isinstance(v.attack_strategy, str) else v.attack_strategy.value,
...
async def get_vulnerability(
    ...
    return api_response({
        ...
        # IMPROVED: Ensure attack_strategy is always a string
        "attack_strategy": vulnerability.attack_strategy if isinstance(vulnerability.attack_strategy, str) else vulnerability.attack_strategy.value,
