...
class PayloadManager:
    ...
    def _load_payloads(self) -> None:
        ...
        try:
            ...
            self.payloads = {"version": "1.0.0", "categories": {}, "metadata": {}}
    ...
    def get_templates(self, category: str, limit: Optional[int] = None) -> List[str]:
        """
    ...
    def generate_payload(self, template: str, original_prompt: str = "", **kwargs) -> str:
        """
    ...
    def get_random_payload(self, category: Optional[str] = None, original_prompt: str = "") -> str:
        """
        ...
        for strategy, category in strategy_to_category_map.items():
            ...
            try:
                ...
                strategy_details[strategy.value] = {
                    ...
                    "status": status,
                    "templates_preview": (
                        templates[:2] if templates else []
                    ),  # First 2 for debugging
                }
        ...
        return {
            ...
            "recommendation": (
                ...
                if coverage_percent >= 90
                    ...
                    else " Poor coverage (<70%) - Add more templates"
                )
            ),
        }
