...
async def get_telemetry_stats(session: AsyncSession = Depends(get_session)):
    """
...
async def get_experiment_logs(experiment_id: UUID, session: AsyncSession = Depends(get_session)):
    """
