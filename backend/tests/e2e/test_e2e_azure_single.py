...
@pytest.mark.e2e
@pytest.mark.skipif(
    os.getenv("DEFAULT_LLM_PROVIDER") != "azure", reason="Azure OpenAI not configured"
)
@pytest.mark.asyncio
async def test_single_prompt_attack_azure():
    ...
    config = ExperimentConfig(
        ...
        strategies=[AttackStrategyType.ROLEPLAY_INJECTION, AttackStrategyType.OBFUSCATION_BASE64],
        max_iterations=5,
