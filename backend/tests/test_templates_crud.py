...
async def test_template_with_all_44_strategies():
    ...
    async with AsyncSessionLocal() as session:
        ...
        assert (
            len(loaded_config.strategies) == 44
        ), f"Expected 44 strategies, got {len(loaded_config.strategies)}"
        assert set(loaded_config.strategies) == set(
            ALL_STRATEGIES
        ...
        print(" Template with all 44 strategies saved and loaded successfully")
...
async def test_template_multi_strategy_selection():
    ...
    async with AsyncSessionLocal() as session:
        ...
        print(" Template with 10 strategies saved and loaded successfully")
