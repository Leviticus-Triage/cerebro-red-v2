  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 text-slate-200">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className={`px-4 py-3 rounded-lg bg-slate-900 border border-slate-700 ${reasonInfo.color}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-900 rounded-lg p-4 border border-slate-800">
            ...
            <div className="text-xs text-slate-500 mt-1">
              Iteration {analysis.best_iteration}
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-800/30">
                  <tr>
                    <th className="px-4 py-2 text-left text-xs font-semibold text-slate-400 uppercase">Strategy</th>
                    <th className="px-4 py-2 text-right text-xs font-semibold text-slate-400 uppercase">Attempts</th>
                    <th className="px-4 py-2 text-right text-xs font-semibold text-slate-400 uppercase">Avg Score</th>
                    <th className="px-4 py-2 text-right text-xs font-semibold text-slate-400 uppercase">Success Rate</th>
                  </tr>
                </thead>
